...
class Wrapper(FeatureSelection):
    """
    Parent class for sequential feature selection methods:

    Args:
        k (int)   : Number of features to select
        step (int): number of features to add/remove at each iteration
    """
    def __init__(self, name, target, model, train, test=None, drops=None, metric=None, Tmax=None, ratio=None,
                 suffix=None, k=None, step=None):
