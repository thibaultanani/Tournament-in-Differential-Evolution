...
class Mrmr(Filter):
    """
    Class that uses Maximum Relevance Minimum Redundancy as a filter method
    """
    ...
    def start(self, pid):
        ...
        top_k_features = mrmr_classif(X=X, y=y, K=self.k)
        ...
        for i in range(len(self.model)):
            ...
            time_debut = timedelta(seconds=(time.time() - debut))
            print_out = self.print_(print_out=print_out, name="MRMR", maxi=score, best=s, mean=s,
